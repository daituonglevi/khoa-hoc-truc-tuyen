...
namespace ELearningWebsite.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, IdentityRole<int>, int>
    {
        ...
        // LiveClass tables: Database-first via database.sql (no EF Core migration generation)
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // LiveClass relationships configured manually in database.sql to avoid EF Core migration conflicts
            // See LiveClassFeature.sql for table schema and foreign key definitions
        }
